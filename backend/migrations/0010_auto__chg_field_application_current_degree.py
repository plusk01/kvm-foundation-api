...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.current_degree'
        db.alter_column(u'backend_application', 'current_degree_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['backend.DegreeType']))

    def backwards(self, orm):

        # Changing field 'Application.current_degree'
        db.alter_column(u'backend_application', 'current_degree_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['backend.DegreeType']))
